...
const validateKey$1 = function (fnName, argumentName, key, optional) {
...
function endAt(value, key) {
    validateKey$1('endAt', 'key', key, true);
...
function startAt(value = null, key) {
    validateKey$1('startAt', 'key', key, true);
...
var GeoQuery = /** @class */ (function () {
    ...
    GeoQuery.prototype.cancel = function () {
        ...
        keys.forEach(function (geohashQueryStr) {
            var q = _this._stringToQuery(geohashQueryStr);
            _this._cancelGeohashQuery(q, _this._currentGeohashesQueried[geohashQueryStr]);
     ...
     */
    GeoQuery.prototype._cancelGeohashQuery = function (q, queryState) {
    ...
    GeoQuery.prototype._childRemovedCallback = function (locationDataSnapshot) {
        ...
        if (key in this._locationsTracked) {
            get(child(this._firebaseRef, key)).then(function (snapshot) {
                var location = (snapshot.val() === null) ? null : decodeGeoFireObject(snapshot.val());
                var geohash = (location !== null) ? geohashForLocation(location) : null;
    ...
    GeoQuery.prototype._cleanUpCurrentGeohashesQueried = function () {
        ...
        keys.forEach(function (geohashQueryStr) {
            ...
            if (queryState.active === false) {
                var query_1 = _this._stringToQuery(geohashQueryStr);
                // Delete the geohash since it should no longer be queried
                _this._cancelGeohashQuery(query_1, queryState);
                delete _this._currentGeohashesQueried[geohashQueryStr];
            }
        });
    ...
    GeoQuery.prototype._geohashInSomeQuery = function (geohash) {
        ...
        for (var _i = 0, keys_3 = keys; _i < keys_3.length; _i++) {
            var queryStr = keys_3[_i];
            if (queryStr in this._currentGeohashesQueried) {
                var query_2 = this._stringToQuery(queryStr);
                if (geohash >= query_2[0] && geohash <= query_2[1]) {
                    return true;
                }
            }
        }
    ...
    GeoQuery.prototype._listenForNewGeohashes = function () {
        ...
        var geohashesToQuery = geohashQueryBounds(this._center, this._radius * 1000).map(this._queryToString);
        ...
        geohashesToQuery.forEach(function (toQueryStr) {
            ...
            var q = _this._stringToQuery(toQueryStr);
            // Create the Firebase query
            var firebaseQuery = query(_this._firebaseRef, orderByChild('g'), startAt(q[0]), endAt(q[1]));
            // For every new matching geohash, determine if we should fire the 'key_entered' event
            var childAddedUnsubscribe = onChildAdded(firebaseQuery, function (a) { return _this._childAddedCallback(a); });
            var childRemovedUnsubscribe = onChildRemoved(firebaseQuery, function (a) { return _this._childRemovedCallback(a); });
            var childChangedUnsubscribe = onChildChanged(firebaseQuery, function (a) { return _this._childChangedCallback(a); });
            ...
            var valueUnsubscribe = onValue(firebaseQuery, function () {
            ...
            _this._currentGeohashesQueried[toQueryStr] = {
                ...
                childRemovedUnsubscribe: childRemovedUnsubscribe,
                childChangedUnsubscribe: childChangedUnsubscribe,
                valueUnsubscribe: valueUnsubscribe
            };
        });
     ...
     */
    GeoQuery.prototype._queryToString = function (q) {
        if (q.length !== 2) {
    ...
    GeoQuery.prototype._removeLocation = function (key, currentLocation) {
        ...
        if (typeof locationDict !== 'undefined' && locationDict.isInQuery) {
            var distanceFromCenter = (currentLocation) ? distanceBetween(currentLocation, this._center) : null;
...
var GeoFire = /** @class */ (function () {
    ...
    GeoFire.prototype.get = function (key) {
        validateKey(key);
        return get(child(this._firebaseRef, key)).then(function (dataSnapshot) {
